                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Modification de la publication </h4>
                  ...
                  <?php
                     ...
                     ?>
                              ...
                              <div class="form-group col-md-6">
                                 <label for="exampleInputEmail1">Titre poste</label>
                              ...
                              <div class="row">
                                 <div class="col-sm-12">
                                    <div class="card-box">
                                       <h4 class="m-b-30 m-t-0 header-title"><b>Image post</b></h4>
                                       <img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
                                       <br />
                                       <a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">mettre a jour Image</a>
                                    </div>
                                 </div>
                              </div>
                              <?php } ?>
                              <button type="submit" name="update" class="btn btn-custom waves-effect waves-light btn-md">mettre a jour </button>
                           </div>
