                  ...
                  <div class="card-body">
                     <div class="row ">
                        <div class="card-header">
                           <h4 class="card-title m-0">Creer en 2023</h4>
                        </div>
                        <div id="chart">
               ...
               <div class="col-lg-2 col-md-2 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     ...
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="Statistics">Listes de categories</p>
            ...
            <a href="manage-posts.php">
               <div class="col-lg-2 col-md-2 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     ...
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="User This Month">Gestion des posts</p>
            ...
            <a href="manage-subcategories.php">
               <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     <i class="mdi mdi-layers widget-one-icon"></i>
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="User This Month">Listes Sous Categories</p>
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="4" align="center">
                              <h3 style="color:red">Rien pour l'istant</h3>
                           </td>
                        <tr>
                           <?php 
                              } else {
