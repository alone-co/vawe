...
if($rowcount==0)
{
echo "Aucune publication pour l'instant..";
}
else {
while ($row=mysqli_fetch_array($query)) {
...
<h1><?php echo htmlentities($row['category']);?> News</h1>
       ...
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
                  <p class="text-right mb-0"><small>Poste le <?php echo htmlentities($row['postingdate']);?></small></p>
              ...
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Voir Plus &rarr;</a>
            </div>
